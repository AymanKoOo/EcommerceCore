...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20221027193327_addedHasSubCategories")]
    partial class addedHasSubCategories
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entites.Catalog.Deal", b =>
                {
                    ...
                    b.Property<bool>("ShowOnSmallBanner")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Core.Entites.DiscountCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("CategoryId", "DiscountsId");
            ...
            modelBuilder.Entity("Core.Entites.Catalog.DealDiscount", b =>
                {
                    b.HasOne("Core.Entites.Catalog.Deal", "deal")
                        .WithMany("DealDiscounts")
                        .HasForeignKey("dealID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Entites.Discount", "discount")
                        .WithMany("DealDiscounts")
