...
namespace Web.Areas.Admin.Factories
{
    public  interface IProductModelFactory
    {
        ...
        Task<ProductListModel> PrepareProductByCategoryListModelAsync(int categoryID, int pageSize, int pageNumber, SpecificationAttributeOption specificationAttributeOption,int OrderFilter);
